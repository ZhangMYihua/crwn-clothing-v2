...
import {getAuth, signInWithRedirects, signInWithPopup, GoogleAuthProvider} from 'firebase/auth'
...
const firebaseConfig = {
  ...
  export const signInWithRedirects = () => signInWithRedirect(auth, provider)
