...
import { UserData, AdditioanalInformation } from "../../utils/firebase/firebase";
...
export type SignUpSuccess     = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: User, additionalDetails: AdditioanalInformation }>
...
export const signUpSuccess = withMatcher((user: User, additionalDetails: AdditioanalInformation ): SignUpSuccess =>
